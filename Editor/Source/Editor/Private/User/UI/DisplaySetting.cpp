...
UDisplaySetting::UDisplaySetting(const FObjectInitializer& ObjectInitializer) :Super(ObjectInitializer)
{
	//	初始化变量
...
// 
// 		UUIManager::GetInstance()->RegisterButtonClick(1, m_BtnQualityLow, this, &UDisplaySetting::SelectQualityLevel);
// 	}
...
// 
// 		UUIManager::GetInstance()->RegisterButtonClick(2, m_BtnQualityHigh, this, &UDisplaySetting::SelectQualityLevel);
// 	}
...
// 
// 		UUIManager::GetInstance()->RegisterButtonClick(3, m_BtnQualityHigher, this, &UDisplaySetting::SelectQualityLevel);
// 	}
...
void UDisplaySetting::OnRelease()
{
...
void UDisplaySetting::OnSetParams(int32 _pid, FString & _content, ...)
{

}

void UDisplaySetting::OnTick(float InDeltaTimeSecond)
{

}

void UDisplaySetting::SelectQualityLevel(int32 _pid)
{
// 	//	画面质量低
// 	if (_pid == 1)
// 	{
...
void UDisplaySetting::SelectClick(EQualityLevel _level)
{
...
EQualityLevel UDisplaySetting::GetCurrentQuality()
{
