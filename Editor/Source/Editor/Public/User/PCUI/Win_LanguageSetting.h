...
#include "Win_LanguageSetting.generated.h"

/**
 * 
 */
UCLASS()
class EDITOR_API UWin_LanguageSetting : public UBaseUI
{
	GENERATED_BODY()
...
public:
	UWin_LanguageSetting(const FObjectInitializer& ObjectInitializer);
