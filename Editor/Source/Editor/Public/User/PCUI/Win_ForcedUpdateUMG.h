...
#include "Win_ForcedUpdateUMG.generated.h"

UCLASS()
class EDITOR_API UWin_ForcedUpdateUMG :public UBaseUI
{
	GENERATED_BODY()
...
public:
	...
	UWin_ForcedUpdateUMG(const FObjectInitializer& ObjectInitializer);
