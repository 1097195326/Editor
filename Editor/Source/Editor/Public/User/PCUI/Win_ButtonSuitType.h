...
#include "Win_ButtonSuitType.generated.h"

/**
 * 
 */
UCLASS()
class EDITOR_API UWin_ButtonSuitType : public UBaseUI
{
	GENERATED_BODY()
public: // 重写以下的类.
	UWin_ButtonSuitType(const FObjectInitializer& ObjectInitializer);
