...
#include "Win_UMGSuitComponentMenu.generated.h"

UCLASS()
class EDITOR_API UWin_UMGSuitComponentMenu : public UBaseUI
{
	GENERATED_BODY()
	UWin_UMGSuitComponentMenu(const FObjectInitializer& ObjectInitializer);
public:
...
private:
	...
	TArray<UWin_UMGMenuCell*> m_MenuCell_Array;
