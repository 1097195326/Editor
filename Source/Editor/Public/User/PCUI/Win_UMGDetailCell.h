...
#include "Win_UMGDetailCell.generated.h"
...
UCLASS()
class EDITOR_API UWin_UMGDetailCell : public UBaseUI
{
	GENERATED_BODY()
...
public:
	UWin_UMGDetailCell(const FObjectInitializer& ObjectInitializer);
