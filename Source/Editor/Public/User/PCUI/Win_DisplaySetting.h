...
#include "Win_DisplaySetting.generated.h"

/**
 * 
 */
UCLASS()
class EDITOR_API UWin_DisplaySetting : public UBaseUI
{
	GENERATED_BODY()
...
public:
	UWin_DisplaySetting(const FObjectInitializer& ObjectInitializer);
