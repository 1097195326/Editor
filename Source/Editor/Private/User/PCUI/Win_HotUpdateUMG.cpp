...
bool UWin_HotUpdateUMG::OnStart()
{
...
void UWin_HotUpdateUMG::OnRelease()
{
...
void UWin_HotUpdateUMG::OnSetParams(int32 _pid, FString & _content, ...)
{

}

void UWin_HotUpdateUMG::OnTick(float InDeltaTimeSecond)
{
...
void UWin_HotUpdateUMG::OnActivationUI()
{

	this->SetVisibility(ESlateVisibility::Visible);
}

void UWin_HotUpdateUMG::OnBackstageUI()
{

	this->SetVisibility(ESlateVisibility::Hidden);
}

void UWin_HotUpdateUMG::Reset()
{
...
void UWin_HotUpdateUMG::SetProgress(DownlaodInfoStruct *_DownloadInfoStruct)
{
